...
mod tests {
    ...
    #[test]
    fn test1() {
        let result = Solution::merge_alternatively("Hello".to_string(), "Hello".to_string());
        assert_eq!(result, "HHeelllloo".to_string());
    }

    #[test]
    fn test2() {
        let result = Solution::merge_alternatively("Hello".to_string(), "World".to_string());
        assert_eq!(result, "HWeolrllod");
    }
}
